    ...
    <div className="min-h-screen bg-[hsl(var(--background))] texture-overlay py-8 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 border-b border-[hsl(var(--primary))]/20 pb-6">
          <div>
            <div className="h-12 w-64 bg-gray-200/50 dark:bg-gray-800/50 rounded-lg animate-pulse mb-4" />
            <div className="h-6 w-96 bg-gray-200/50 dark:bg-gray-800/50 rounded-lg animate-pulse" />
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
          {Array.from({ length: 10 }).map((_, i) => (
            <div key={i} className="rounded-2xl bg-white/50 dark:bg-gray-800/30 border border-white dark:border-gray-700 p-4 h-[280px] flex flex-col relative overflow-hidden animate-pulse">
              ...
              <div className="relative z-10 mt-auto flex items-center justify-between border-t border-gray-100 dark:border-gray-700 pt-4">
