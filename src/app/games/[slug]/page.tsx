...
export default function GameDetailPage() {
  ...
  const canCheckout =
    game.fields.every((f) => fieldValues[f.key]?.trim()) &&
    selectedProduct &&
    selectedPayment;
  ...
  const handleCheckout = async () => {
    ...
    const userIdKey = game.fields[0]?.key;
    const zoneIdKey = game.fields[1]?.key;
        ...
        <div className="grid gap-8 lg:grid-cols-12 relative">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <DenominationGrid 
              ...
              stepNum={game.fields.length > 0 ? 2 : 1}
            />
            ...
            <PaymentMethodList 
              ...
              stepNum={game.fields.length > 0 ? 3 : 2}
            />
          </div>
