  ...
  return (
    <section className="py-12 bg-[hsl(var(--background))]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-blue-600 px-6 py-12 sm:px-12 sm:py-16 shadow-lg">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="max-w-xl text-center md:text-left">
              <Typography.Heading level="h2" className="text-white mb-6">
                Top Up Praktis. <br />
                <span className="text-yellow-400">Harga Ekonomis.</span>
              </Typography.Heading>
              ...
              <Button size="lg" className="bg-yellow-400 text-blue-900 hover:bg-yellow-300 rounded-full h-14 px-8 text-lg font-semibold shadow-md transition-all w-full sm:w-auto">
                Lihat Promo
              </Button>
            </div>
