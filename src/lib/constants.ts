...
export const POPULAR_GAMES: Game[] = [
  {
    ...
    banner: "/images/mobile-legends.webp",
    color: "#1a56db",
    fields: [
  ...
  },
  {
    ...
    banner: "/images/pubg-mobile.webp",
    color: "#f5a623",
    fields: [
  ...
  },
  {
    ...
    banner: "/images/genshin-impact.webp",
    color: "#5b8cff",
    fields: [
  ...
  },
  {
    ...
    banner: "/images/honkai-star-rail.webp",
    color: "#a855f7",
    fields: [
      { key: "user_id", label: "UID", placeholder: "Masukkan UID", type: "text" },
      {
  ...
  },
  {
    ...
    publisher: "Valve",
    category: "pc",
    image: "/images/steam-wallet.webp",
    banner: "/images/steam-wallet.webp",
    color: "#171a21",
    fields: [],
    popular: true,
  },
